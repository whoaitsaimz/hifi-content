name = party-girl-pearl-flapper-dress
type = body+head
scale = 1
filename = party-girl-pearl-flapper-dress/party-girl-pearl-flapper-dress.fbx
texdir = party-girl-pearl-flapper-dress/textures
joint = jointRoot = Body
...
jointIndex = skirt.001 = 1
jointIndex = left_shoe = 5
jointIndex = hair = 4
jointIndex = Body = 3
jointIndex = right_shoe = 2
jointIndex = right foot = 0
